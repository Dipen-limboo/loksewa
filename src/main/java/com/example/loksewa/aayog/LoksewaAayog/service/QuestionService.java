...
public class QuestionService {
	...
	public ResponseEntity<?> saveQuestion(@Valid QuestionDTO questionDto) {
	...
	public ResponseEntity<?> viewListQuestion(Pageable pageable){
	...
	public ResponseEntity<?> editingQuestion(Long id){
	...
	public ResponseEntity<?> updateQuestions(Long id, EditQuestionDto editQuestionDto){
	...
	public ResponseEntity<?> deleteQuesiton(Long id){
