...
public class AnswerService {
	...
	public ResponseEntity<?> geQuestionSet(Long category_id, Long position_id){
	...
	public ResponseEntity<?> answeringQuestion(Long id, @RequestBody AnswerSetDto answerSetDto, Authentication auth){
	...
	public ResponseEntity<?> getAnswersByExams(Long id){
